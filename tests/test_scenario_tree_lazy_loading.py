...
class TestTreeLazyLoading(WebTestCase):
    ...
    def test(self, page: Page):
        ...
        self.assertIsNone(loader.get_attribute('hx-select'))
        ...
        self.assertNotIn('<table', response_markup)
        self.assertNotIn('<colgroup', response_markup)
        self.assertNotIn('<thead', response_markup)
        self.assertNotIn('<tbody', response_markup)
        self.assertNotIn('vs-tree-total-row', response_markup)
        ...
        self.assertIn('vs-tree-total-row', response_markup)
